...
project = u'brutus'
copyright = u'2016, Frédéric P.A. Vogt'
...
version = np.str(brutus.__version__)[:-2]
# The full version, including alpha/beta/rc tags.
release = np.str(brutus.__version__)
...
man_pages = [
    (master_doc, 'brian', u'brian Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'brian', u'brian Documentation',
     author, 'brian', 'One line description of project.',
     'Miscellaneous'),
]
